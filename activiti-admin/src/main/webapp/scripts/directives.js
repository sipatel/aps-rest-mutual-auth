...
angular.module('activitiAdminApp')
    ...
    return {
        ...
        link: function ($scope, $element, attributes) {
            ...
            $scope.downloadContentUrl = function(contentId) {
            	return "app/rest/activiti/submitted-forms/content/"+contentId+"/raw?serverId="+$scope.activeServerId;
            }
    ...
    directive('user', function(identityService) {
        return {link: function(scope, element, attrs) {
