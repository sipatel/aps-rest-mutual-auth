	    ...
	    .then(function(headers) { 
          ...
          $scope.gridDefinitions = {
              ...
              columnDefs: [{ field: 'id', displayName: headers[0], width: 50, cellTemplate: gridConstants.defaultTemplate},
                  ...
                  { field: 'assignee', displayName: headers[2], width: 150, cellTemplate: gridConstants.userTemplate},
                  { field: 'owner', displayName: headers[3], width: 150, cellTemplate: gridConstants.userTemplate},
