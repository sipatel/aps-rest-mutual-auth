...
activitiAdminApp.controller('DecisionTableController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$routeParams', '$modal', '$translate', '$q', 'gridConstants',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q, gridConstants) {
        ...
        $scope.executeWhenReady(function () {
            // Load deployment
            $http({method: 'GET', url: '/app/rest/activiti/decision-tables/' + $routeParams.decisionTableId, params: {serverId: $rootScope.activeServer.id}}).
            success(function (data, status, headers, config) {
                ...
                $http({method: 'GET', url: '/app/rest/activiti/app?dmnDeploymentId=' + data.deploymentId, params: {serverId: $rootScope.activeServer.id}}).
