 ...
 * @author Joram Barrez
 */
public class SecureScriptTaskExecution06 {

    public static void main(String[] args) {

        // Enable class white listing + max execution time + for each byte code instruction a check + max stack depth + memory check
        // No impact
